...
The simple page builder also has an application you can download [for mac](https://github.com/puresamari/spb-app/releases/download/v0.0.5/SPB-mac.zip) (Its in really early development phase).
